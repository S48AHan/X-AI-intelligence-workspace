...
export function DashboardHeader({ section, range }: { section: string; range?: string }) {
  return (
    <div className="flex items-center justify-between">
      <div><h3 className="text-xl font-semibold">{section}</h3><div className="mt-0.5 text-[13px] text-t3">{range ? `Live intelligence · ${range}` : "Workspace preferences and access"}</div></div>
